...
public partial class EVDataAnalyticsMarketplaceDBContext : DbContext
{
    ...
    public virtual DbSet<DataQualityFlag> DataQualityFlags { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DataQualityFlag>(entity =>
        {
            entity.HasKey(e => e.FlagId).HasName("PK__DataQual__780D4593A614AC2A");

            entity.HasIndex(e => e.DatasetVersionId, "IX_DataQualityFlags_VersionId");
            ...
            entity.HasOne(d => d.DatasetVersion).WithMany(p => p.DataQualityFlags)
                .HasForeignKey(d => d.DatasetVersionId)
                .HasConstraintName("FK_DataQualityFlags_Version");
        });
