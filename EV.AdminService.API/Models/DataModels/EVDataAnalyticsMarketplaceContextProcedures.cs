...
{
    public partial class EVDataAnalyticsMarketplaceContext
    {
        private IEVDataAnalyticsMarketplaceContextProcedures _procedures;

        public virtual IEVDataAnalyticsMarketplaceContextProcedures Procedures
        {
            get
            {
                if (_procedures is null) _procedures = new EVDataAnalyticsMarketplaceContextProcedures(this);
                return _procedures;
            }
            set
            {
        ...
        public IEVDataAnalyticsMarketplaceContextProcedures GetProcedures()
        {
            return Procedures;
        }
    }

    public partial class EVDataAnalyticsMarketplaceContextProcedures : IEVDataAnalyticsMarketplaceContextProcedures
    {
        private readonly EVDataAnalyticsMarketplaceContext _context;

        public EVDataAnalyticsMarketplaceContextProcedures(EVDataAnalyticsMarketplaceContext context)
        {
            _context = context;
        }
